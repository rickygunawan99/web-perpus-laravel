...
{{--    'public/assets/vendor/fonts/tabler-icons.css',--}}
...
{{--@vite([--}}
{{--    "public/assets/vendor/css" .$configData['rtlSupport'] .'/core' .($configData['style'] !== 'light' ? '-' . $configData['style'] : '') .'.css',--}}
{{--    "public/assets/vendor/css" .$configData['rtlSupport'] .'/' .$configData['theme'] .($configData['style'] !== 'light' ? '-' . $configData['style'] : '') .'.css',--}}
{{--])--}}
<link rel="stylesheet" class="{{ $configData['hasCustomizer'] ? 'template-customizer-core-css' : '' }}" />
<link rel="stylesheet" class="{{ $configData['hasCustomizer'] ? 'template-customizer-theme-css' : '' }}" />

{{--@vite('public/assets/css/demo.css')--}}
...
{{--    "public/assets/vendor/libs/node-waves/node-waves.css",--}}
{{--    "public/assets/vendor/libs/typeahead-js/typeahead.css",--}}
{{--])--}}
